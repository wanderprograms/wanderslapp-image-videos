...
// ✅ ImageKit config
const imagekitPublicKey = "public_4CXyhqpxAQZ3XobEBAIbOrmjbLM=";
...
uploadForm.onsubmit = async (e) => {
  ...
  if (!file || !title) {
    logDebug("❌ Missing title or file.");
  ...
  try {
    ...
    logDebug("📦 FormData prepared:", { fileName: file.name });
    ...
    logDebug("📥 Response from ImageKit:", data);
    ...
    logDebug("✅ Upload successful:", { url: data.url });
