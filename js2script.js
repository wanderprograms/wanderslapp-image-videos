...
const imagekit = new ImageKit({
  publicKey: "public_4CXyhqpxAQZ3XobEBAIbOrmjbLM=",
  urlEndpoint: "https://ik.imagekit.io/wio2rlawfv" // 🔁 ikani ID yanu apa
});
...
// 📤 Upload logic using ImageKit SDK
uploadForm.onsubmit = async (e) => {
  ...
  imagekit.upload({
    ...
    if (err || !result || !result.url) {
      console.error("Upload error:", err || result);
